...
gcc -Wall -Wextra -Werror -g -o $TESTMAIN.o -I ../ -I ../includes/ -I ../libft/includes -c -x c $TESTMAIN.test
gcc -g -o tests_printf $TESTMAIN.o -I ../ -I ../includes/ -I ../libft/includes -L ../ -L ../libft -lftprintf -lft
